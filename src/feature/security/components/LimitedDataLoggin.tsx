        ...
        <div className="w-full ">
          <div className="relative">
            ...
            <Image
              ...
              width={600}
              height={600}
              className="absolute -right-40 -top-12 lg:right-[10%] 2xl:-right-[15%] lg:-top-[150px] 2xl:-top-[110px] w-contain h-auto lg:scale-150 z-0 2xl:hidden"
              draggable={false}
            />
            <svg
              className="absolute -left-[44%] lg:-left-[386%] 2xl:left-[45%] h-[274px] lg:h-[300px]  lg:top-[190px] 2xl:-top-[120px] z-0 hidden 2xl:block pointer-events-none transform scale-x-[-1]"
