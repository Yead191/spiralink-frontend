...
const ExplicitConsent = () => {
  return (
    <div className='container flex flex-col md:flex-row items-center gap-10 py-8 md:gap-5 lg:py-16'>
      {/* Left Side Content */}
      <div className="w-full md:w-1/2 xl:w-[60%]">
        ...
        <p className='section-subtitle xl:whitespace-nowrap!'>When a conversation involves the processing or logging of personal <br /> data, the voicebot clearly informs the caller.</p>
        ...
        <div className="mt-5">
          ...
          <p className='section-subtitle mt-7 whitespace-normal'>Only after consent is given does the system continue within that scope.</p>
        </div>
      </div>
      {/* Right Side Content */}
      <div className="relative w-full md:w-1/2 xl:w-[40%]">
        <Image width={400} height={200} quality={100} src="/assets/bg/security/shield-bg.png" alt="Image" className="lg:w-1/3 xl:w-full rounded-lg shadow-lg" />

        <div className="absolute -bottom-1/5 lg:bottom-20 lg:left-10 md:hidden  xl:block">
          <Card className='bg-black! border border-gray-800! xl:min-w-lg  relative '>
            <p className='text-xl text-primary font-bold mb-3'>If consent is not granted or is withdrawn:</p>
            <ul className='flex flex-col gap-4 text-lg text-white mb-5'>
            ...
            <p className='section-subtitle'>This ensures lawful processing and transparency under GDPR.</p>
