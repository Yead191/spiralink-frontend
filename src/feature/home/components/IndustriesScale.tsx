  ...
  return (
    ...
    >
      <div className="container flex flex-col items-center text-center z-10 relative">
        ...
        <p className="section-subtitle max-w-2xl leading-relaxed mb-12">
          ...
          <div className="flex flex-wrap justify-center gap-3 md:gap-4">
            {industries?.map((item, index) => (
              <div
                ...
                className="group flex items-center gap-2.5 px-6 py-3 rounded-full border border-white/5 hover:border-purple-500/50 hover:bg-[#111] transition-all duration-300"
              >
